 ...
 */
public class ReflectionQuestionsFragment extends Fragment {
    ...
    TaskHelper taskHelper = new TaskHelper() {
        ...
        public void processFinish(TreeMap<Long, String> output) {
            ...
            qHelper.openDialog(ReflectionQuestionsFragment.this, output);
        }};
    ...
    public ReflectionQuestionsFragment() {
        //dummy
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.reflection_questions_layout, container, false);

        helper = new ReflectionHelper(view);

        helper.initializeUIElements();

        // setting imageViews initialized on reflectionHelper in this List viewImages
    ...
    private void settingBtnsListeners() {
        ...
        cleanBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.detach(ReflectionQuestionsFragment.this).attach(ReflectionQuestionsFragment.this).commit();
            }
        });
    }

    private void initializeMainButtons() {
        confirmBtn = (Button)view.findViewById(R.id.reflection_questions_btn_confirm);
        cleanBtn = (Button)view.findViewById(R.id.reflection_questions_btn_clean);
    }

    private void initializeRadioButtons() {
        radioGroupQ1 = (RadioGroup)view.findViewById(R.id.reflection_radio_group1);
        radioGroupQ2 = (RadioGroup)view.findViewById(R.id.reflection_radio_group2);
        radioGroupQ3 = (RadioGroup)view.findViewById(R.id.reflection_radio_group3);
        radioGroupQ4 = (RadioGroup)view.findViewById(R.id.reflection_radio_group4);
        radioGroupQ5 = (RadioGroup)view.findViewById(R.id.reflection_radio_group5);
        radioGroupQ6 = (RadioGroup)view.findViewById(R.id.reflection_radio_group6);
        radioGroupQ7 = (RadioGroup)view.findViewById(R.id.reflection_radio_group7);
        radioGroupQ8 = (RadioGroup)view.findViewById(R.id.reflection_radio_group8);
        radioGroupQ9 = (RadioGroup)view.findViewById(R.id.reflection_radio_group9);
        radioGroupQ10 = (RadioGroup)view.findViewById(R.id.reflection_radio_group10);
    }
